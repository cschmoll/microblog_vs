...
from app_package.forms import LoginForm, EmptyForm, PostForm
from flask_login import current_user, login_user, logout_user, login_required
import sqlalchemy as sa
from app_package import db
from app_package.models import User, Post
from app_package.forms import RegistrationForm, EditProfileForm, ResetPasswordRequestForm
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        app.logger.info(_('Your changes have been saved.'))
